...
import 'cr_dashboard_screen.dart';
import 'notice_screen.dart';
import 'voting_screen.dart';

class VotingHomeScreen extends StatefulWidget {
  const VotingHomeScreen({super.key, required this.isCR});
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => CRDashboardScreen(
                          currentCREmail:
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NoticeScreen(isCR: widget.isCR),
                    ),
                  );
                },
              ),
              ListTile(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => VotingScreen(isCR: widget.isCR),
                    ),
                  );
                },
              ),
              ListTile(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ContentScreen(isCR: widget.isCR),
                    ),
                  );
                },
              ),
                      ...
                      _buildQuickActionButton(
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  ContentScreen(isCR: widget.isCR),
                            ),
                          );
                        },
                      ),
