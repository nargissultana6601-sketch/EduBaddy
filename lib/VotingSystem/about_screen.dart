          ...
          child: Column(
            ...
            children: [
              ...
              _buildFeatureCard(
                ...
                description:
                    "Access course materials, CT syllabus, and study resources",
                color: Colors.blue,
              ),
              _buildFeatureCard(
                icon: Icons.poll,
                title: "Voting System",
                description:
                    "Create polls with timers, CT assignments, and real-time results",
                color: Colors.green,
              ),
              _buildFeatureCard(
                ...
                title: "Notices",
                description:
                    "CR can post important announcements for students",
                color: Colors.orange,
              ),
              _buildFeatureCard(
                ...
                title: "CR Dashboard",
                description:
                    "Transfer CR role, view history, and manage class activities",
                color: Colors.purple,
              ),
              ...
              _buildFeatureCard(
                ...
                description:
                    "Safely transfer CR responsibilities to another student",
                color: Colors.teal,
              ),
              _buildFeatureCard(
                icon: Icons.history,
                ...
                description:
                    "Track all CR role transfers with timestamps",
                color: Colors.brown,
              ),
              const SizedBox(height: 24),
              Card(
